...
# Project:  GUI.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile GUI.pro
#############################################################################
...
INCPATH       = -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I. -I/usr/include/qt5 -I/usr/include/qt5/QtOpenGL -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtNetwork -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I. -I.
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 -lglut -lGLU -lQt5OpenGL -L/usr/lib/x86_64-linux-gnu -lQt5Widgets -lQt5Network -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
...
SOURCES       = main.cpp \
		...
		ground.cpp \
		target.cpp \
		move_ground.cpp moc_mainwindow.cpp \
		moc_glwidget.cpp
OBJECTS       = main.o \
		mainwindow.o \
		glwidget.o \
...
Makefile: GUI.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/shell-unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/GUI1.0.0/ && $(COPY_FILE) --parents mainwindow.h glwidget.h server.h object.h material.h color4f.h cube.h drone.h axis.h ground.h target.h move_ground.h .tmp/GUI1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp glwidget.cpp server.cpp cube.cpp drone.cpp axis.cpp ground.cpp target.cpp move_ground.cpp .tmp/GUI1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/GUI1.0.0/ && (cd `dirname .tmp/GUI1.0.0` && $(TAR) GUI1.0.0.tar GUI1.0.0 && $(COMPRESS) GUI1.0.0.tar) && $(MOVE) `dirname .tmp/GUI1.0.0`/GUI1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/GUI1.0.0
...
move_ground.o: move_ground.cpp move_ground.h \
		object.h \
		glwidget.h \
		/usr/include/qt5/QtOpenGL/QGLWidget \
		/usr/include/qt5/QtOpenGL/qgl.h \
		...
		material.h \
		color4f.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o move_ground.o move_ground.cpp
